...
server.tool('consultar_placa', 'Consulta dados completos de veiculo pela placa brasileira. Retorna marca, modelo, ano, cor, chassi, UF, municipio e valor da Tabela FIPE.', { placa: z.string().describe('Placa sem traco: ABC1234 (antiga) ou ABC1D23 (Mercosul)') }, async ({ placa }) => {
    try {
